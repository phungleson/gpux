...
use crate::{color_scale::ColorScale, color_scale_set::ColorScaleSet};
...
impl TryFrom<StaticColorScale> for ColorScale {
    type Error = anyhow::Error;

    fn try_from(value: StaticColorScale) -> Result<ColorScale, Self::Error> {
        value
            .into_iter()
...
impl TryFrom<StaticColorScaleSet> for ColorScaleSet {
    ...
    fn try_from(value: StaticColorScaleSet) -> Result<Self, Self::Error> {
        Ok(Self::new(
            value.scale,
            value.light.try_into()?,
            value.light_alpha.try_into()?,
            value.dark.try_into()?,
            value.dark_alpha.try_into()?,
        ))
    }
}
